<script lang="ts">
	import { thePathToCarcosaCampaign } from '$lib/campaign/ptc/campaign'
...
<PageTitle subTitle="Tool" title={'Campaign Reference: ' + thePathToCarcosaCampaign.name} helpMd={help} />
