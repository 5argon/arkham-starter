...
class GlobalSettings$Type extends MessageType<GlobalSettings> {
	constructor() {
		super('GlobalSettings', [
			{ no: 1, name: 'taboo', kind: 'scalar', T: 8 /*ScalarType.BOOL*/ },
			{
				...
				name: 'pip_style',
				kind: 'enum',
				T: () => ['GlobalSettings.PipStyle', GlobalSettings_PipStyle],
			},
		])
	}
	create(value?: PartialMessage<GlobalSettings>): GlobalSettings {
		const message = { taboo: false, pipStyle: 0 }
		globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this })
		if (value !== undefined) reflectionMergePartial<GlobalSettings>(this, message, value)
		return message
	}
	internalBinaryRead(
	...
	internalBinaryWrite(
		...
		/* bool taboo = 1; */
		if (message.taboo !== false) writer.tag(1, WireType.Varint).bool(message.taboo)
		/* GlobalSettings.PipStyle pip_style = 2; */
		if (message.pipStyle !== 0) writer.tag(2, WireType.Varint).int32(message.pipStyle)
