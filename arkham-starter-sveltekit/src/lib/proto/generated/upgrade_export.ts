...
class UpgradeExportProto$Type extends MessageType<UpgradeExportProto> {
	...
	create(value?: PartialMessage<UpgradeExportProto>): UpgradeExportProto {
		...
		if (value !== undefined) reflectionMergePartial<UpgradeExportProto>(this, message, value)
		return message
	}
	internalBinaryRead(
		...
		while (reader.pos < end) {
			...
			switch (fieldNo) {
				case /* repeated UpgradeExportRow upgrade_rows */ 1:
					message.upgradeRows.push(
						UpgradeExportRow.internalBinaryRead(reader, reader.uint32(), options),
					)
					break
				case /* UpgradeExportOptions upgrade_export_options */ 2:
					message.upgradeExportOptions = UpgradeExportOptions.internalBinaryRead(
						reader,
						reader.uint32(),
						options,
				...
				case /* ExportOptions export_options */ 3:
					message.exportOptions = ExportOptions.internalBinaryRead(
						reader,
						reader.uint32(),
						options,
	...
	internalBinaryWrite(
		...
		for (let i = 0; i < message.upgradeRows.length; i++)
			UpgradeExportRow.internalBinaryWrite(
				message.upgradeRows[i],
				writer.tag(1, WireType.LengthDelimited).fork(),
				options,
			).join()
		/* UpgradeExportOptions upgrade_export_options = 2; */
		if (message.upgradeExportOptions)
			UpgradeExportOptions.internalBinaryWrite(
				message.upgradeExportOptions,
		...
		if (message.exportOptions)
			ExportOptions.internalBinaryWrite(
				message.exportOptions,
...
class UpgradeExportRow$Type extends MessageType<UpgradeExportRow> {
	...
	create(value?: PartialMessage<UpgradeExportRow>): UpgradeExportRow {
		...
		globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this })
		if (value !== undefined) reflectionMergePartial<UpgradeExportRow>(this, message, value)
		return message
	}
	internalBinaryRead(
		reader: IBinaryReader,
	...
	internalBinaryWrite(
		...
		/* string mark = 1; */
		if (message.mark !== '') writer.tag(1, WireType.LengthDelimited).string(message.mark)
		/* string card_left = 2; */
		if (message.cardLeft !== '') writer.tag(2, WireType.LengthDelimited).string(message.cardLeft)
		/* string card_right = 3; */
		if (message.cardRight !== '') writer.tag(3, WireType.LengthDelimited).string(message.cardRight)
		/* bool xp_unlocked = 4; */
		if (message.xpUnlocked !== false) writer.tag(4, WireType.Varint).bool(message.xpUnlocked)
		...
		/* int32 xp = 6; */
		if (message.xp !== 0) writer.tag(6, WireType.Varint).int32(message.xp)
		/* int32 cumulative_xp = 7; */
		if (message.cumulativeXp !== 0) writer.tag(7, WireType.Varint).int32(message.cumulativeXp)
		/* string divider_text = 8; */
		if (message.dividerText !== '')
			writer.tag(8, WireType.LengthDelimited).string(message.dividerText)
		/* bool divider = 9; */
		if (message.divider !== false) writer.tag(9, WireType.Varint).bool(message.divider)
		/* bool right_custom = 10; */
		if (message.rightCustom !== false) writer.tag(10, WireType.Varint).bool(message.rightCustom)
...
class UpgradeExportOptions$Type extends MessageType<UpgradeExportOptions> {
	constructor() {
		super('UpgradeExportOptions', [
			...
			{
				no: 8,
				name: 'simple_list_options',
				kind: 'message',
				T: () => UpgradeExportOptions_SimpleListOptions,
			},
	...
	create(value?: PartialMessage<UpgradeExportOptions>): UpgradeExportOptions {
		const message = {
			...
			showLink: false,
			showLinkText: '',
			upgradeExportStyle: 0,
		}
		globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this })
		if (value !== undefined) reflectionMergePartial<UpgradeExportOptions>(this, message, value)
		return message
	}
	internalBinaryRead(
		reader: IBinaryReader,
		...
		while (reader.pos < end) {
			...
			switch (fieldNo) {
				...
				case /* UpgradeExportOptions.Arrow arrow */ 5:
					message.arrow = UpgradeExportOptions_Arrow.internalBinaryRead(
						reader,
						reader.uint32(),
						options,
						message.arrow,
				...
				case /* UpgradeExportOptions.Headers headers */ 6:
					message.headers = UpgradeExportOptions_Headers.internalBinaryRead(
						reader,
						reader.uint32(),
						options,
						message.headers,
				...
				case /* UpgradeExportOptions.Columns columns */ 7:
					message.columns = UpgradeExportOptions_Columns.internalBinaryRead(
						reader,
						reader.uint32(),
						options,
						message.columns,
				...
				case /* UpgradeExportOptions.SimpleListOptions simple_list_options */ 8:
					message.simpleListOptions = UpgradeExportOptions_SimpleListOptions.internalBinaryRead(
						reader,
						reader.uint32(),
						options,
	...
	internalBinaryWrite(
		...
		/* bool simple_list = 1; */
		if (message.simpleList !== false) writer.tag(1, WireType.Varint).bool(message.simpleList)
		/* bool split_divider = 2; */
		if (message.splitDivider !== false) writer.tag(2, WireType.Varint).bool(message.splitDivider)
		/* string xp_suffix = 3; */
		if (message.xpSuffix !== '') writer.tag(3, WireType.LengthDelimited).string(message.xpSuffix)
		/* bool ignore_small = 4; */
		if (message.ignoreSmall !== false) writer.tag(4, WireType.Varint).bool(message.ignoreSmall)
		/* UpgradeExportOptions.Arrow arrow = 5; */
		if (message.arrow)
			UpgradeExportOptions_Arrow.internalBinaryWrite(
				message.arrow,
		...
		if (message.headers)
			UpgradeExportOptions_Headers.internalBinaryWrite(
				message.headers,
		...
		if (message.columns)
			UpgradeExportOptions_Columns.internalBinaryWrite(
				message.columns,
		...
		if (message.simpleListOptions)
			UpgradeExportOptions_SimpleListOptions.internalBinaryWrite(
				message.simpleListOptions,
				writer.tag(8, WireType.LengthDelimited).fork(),
				options,
			).join()
		/* bool upgradeUrl = 9; */
		if (message.upgradeUrl !== false) writer.tag(9, WireType.Varint).bool(message.upgradeUrl)
		/* bool show_link = 10; */
		if (message.showLink !== false) writer.tag(10, WireType.Varint).bool(message.showLink)
...
class UpgradeExportOptions_Arrow$Type extends MessageType<UpgradeExportOptions_Arrow> {
	...
	internalBinaryRead(
		...
		length: number,
		options: BinaryReadOptions,
		target?: UpgradeExportOptions_Arrow,
	): UpgradeExportOptions_Arrow {
		const message = target ?? this.create(),
			end = reader.pos + length
		while (reader.pos < end) {
			const [fieldNo, wireType] = reader.tag()
	...
	internalBinaryWrite(
		message: UpgradeExportOptions_Arrow,
		writer: IBinaryWriter,
		options: BinaryWriteOptions,
	): IBinaryWriter {
		/* string character = 1; */
		if (message.character !== '') writer.tag(1, WireType.LengthDelimited).string(message.character)
...
class UpgradeExportOptions_Headers$Type extends MessageType<UpgradeExportOptions_Headers> {
	...
	internalBinaryRead(
		...
		length: number,
		options: BinaryReadOptions,
		target?: UpgradeExportOptions_Headers,
	): UpgradeExportOptions_Headers {
		const message = target ?? this.create(),
			end = reader.pos + length
		while (reader.pos < end) {
			const [fieldNo, wireType] = reader.tag()
	...
	internalBinaryWrite(
		message: UpgradeExportOptions_Headers,
		writer: IBinaryWriter,
		options: BinaryWriteOptions,
	): IBinaryWriter {
...
class UpgradeExportOptions_Columns$Type extends MessageType<UpgradeExportOptions_Columns> {
	...
	internalBinaryRead(
		...
		length: number,
		options: BinaryReadOptions,
		target?: UpgradeExportOptions_Columns,
	): UpgradeExportOptions_Columns {
		const message = target ?? this.create(),
			end = reader.pos + length
		while (reader.pos < end) {
			const [fieldNo, wireType] = reader.tag()
	...
	internalBinaryWrite(
		message: UpgradeExportOptions_Columns,
		writer: IBinaryWriter,
		options: BinaryWriteOptions,
	): IBinaryWriter {
		/* bool mark_column = 1; */
		if (message.markColumn !== false) writer.tag(1, WireType.Varint).bool(message.markColumn)
		/* bool xp_column = 2; */
		if (message.xpColumn !== false) writer.tag(2, WireType.Varint).bool(message.xpColumn)
...
class UpgradeExportOptions_SimpleListOptions$Type extends MessageType<UpgradeExportOptions_SimpleListOptions> {
	...
	create(
		value?: PartialMessage<UpgradeExportOptions_SimpleListOptions>,
	...
	internalBinaryRead(
		...
		length: number,
		options: BinaryReadOptions,
		target?: UpgradeExportOptions_SimpleListOptions,
	): UpgradeExportOptions_SimpleListOptions {
		const message = target ?? this.create(),
			end = reader.pos + length
		while (reader.pos < end) {
	...
	internalBinaryWrite(
		message: UpgradeExportOptions_SimpleListOptions,
		writer: IBinaryWriter,
		options: BinaryWriteOptions,
	): IBinaryWriter {
		/* UpgradeExportOptions.SimpleListOptions.BlockStyle block_style = 1; */
		if (message.blockStyle !== 0) writer.tag(1, WireType.Varint).int32(message.blockStyle)
		const u = options.writeUnknownFields
		if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer)
		return writer
	}
 ...
 */
export const UpgradeExportOptions_SimpleListOptions =
	new UpgradeExportOptions_SimpleListOptions$Type()
