...
class TeamAssemblerProto$Type extends MessageType<TeamAssemblerProto> {
    constructor() {
        super("TeamAssemblerProto", [
            { no: 1, name: "input_decks_1", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => TeamAssemblerProto_InputDeck },
            { no: 2, name: "input_decks_2", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => TeamAssemblerProto_InputDeck },
            { no: 3, name: "input_decks_3", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => TeamAssemblerProto_InputDeck },
            { no: 4, name: "input_decks_4", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => TeamAssemblerProto_InputDeck },
            { no: 5, name: "current_team", kind: "scalar", repeat: 2 /*RepeatType.UNPACKED*/, T: 9 /*ScalarType.STRING*/ },
            { no: 6, name: "picked_assembly", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => TeamAssemblerProto_PickedAssembly },
            { no: 7, name: "user_patches", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => TeamAssemblerProto_UserPatch },
            { no: 8, name: "advanced", kind: "scalar", T: 8 /*ScalarType.BOOL*/ }
        ]);
    }
    create(value?: PartialMessage<TeamAssemblerProto>): TeamAssemblerProto {
        const message = { inputDecks1: [], inputDecks2: [], inputDecks3: [], inputDecks4: [], currentTeam: [], pickedAssembly: [], userPatches: [], advanced: false };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
            reflectionMergePartial<TeamAssemblerProto>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: TeamAssemblerProto): TeamAssemblerProto {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* repeated TeamAssemblerProto.InputDeck input_decks_1 */ 1:
                    message.inputDecks1.push(TeamAssemblerProto_InputDeck.internalBinaryRead(reader, reader.uint32(), options));
                    break;
                case /* repeated TeamAssemblerProto.InputDeck input_decks_2 */ 2:
                    message.inputDecks2.push(TeamAssemblerProto_InputDeck.internalBinaryRead(reader, reader.uint32(), options));
                    break;
                case /* repeated TeamAssemblerProto.InputDeck input_decks_3 */ 3:
                    message.inputDecks3.push(TeamAssemblerProto_InputDeck.internalBinaryRead(reader, reader.uint32(), options));
                    break;
                case /* repeated TeamAssemblerProto.InputDeck input_decks_4 */ 4:
                    message.inputDecks4.push(TeamAssemblerProto_InputDeck.internalBinaryRead(reader, reader.uint32(), options));
                    break;
                ...
                case /* repeated TeamAssemblerProto.PickedAssembly picked_assembly */ 6:
                    message.pickedAssembly.push(TeamAssemblerProto_PickedAssembly.internalBinaryRead(reader, reader.uint32(), options));
                    break;
                case /* repeated TeamAssemblerProto.UserPatch user_patches */ 7:
                    message.userPatches.push(TeamAssemblerProto_UserPatch.internalBinaryRead(reader, reader.uint32(), options));
                    break;
    ...
    internalBinaryWrite(message: TeamAssemblerProto, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* repeated TeamAssemblerProto.InputDeck input_decks_1 = 1; */
        for (let i = 0; i < message.inputDecks1.length; i++)
            TeamAssemblerProto_InputDeck.internalBinaryWrite(message.inputDecks1[i], writer.tag(1, WireType.LengthDelimited).fork(), options).join();
        /* repeated TeamAssemblerProto.InputDeck input_decks_2 = 2; */
        for (let i = 0; i < message.inputDecks2.length; i++)
            TeamAssemblerProto_InputDeck.internalBinaryWrite(message.inputDecks2[i], writer.tag(2, WireType.LengthDelimited).fork(), options).join();
        /* repeated TeamAssemblerProto.InputDeck input_decks_3 = 3; */
        for (let i = 0; i < message.inputDecks3.length; i++)
            TeamAssemblerProto_InputDeck.internalBinaryWrite(message.inputDecks3[i], writer.tag(3, WireType.LengthDelimited).fork(), options).join();
        /* repeated TeamAssemblerProto.InputDeck input_decks_4 = 4; */
        for (let i = 0; i < message.inputDecks4.length; i++)
            TeamAssemblerProto_InputDeck.internalBinaryWrite(message.inputDecks4[i], writer.tag(4, WireType.LengthDelimited).fork(), options).join();
        ...
        for (let i = 0; i < message.pickedAssembly.length; i++)
            TeamAssemblerProto_PickedAssembly.internalBinaryWrite(message.pickedAssembly[i], writer.tag(6, WireType.LengthDelimited).fork(), options).join();
        /* repeated TeamAssemblerProto.UserPatch user_patches = 7; */
        for (let i = 0; i < message.userPatches.length; i++)
            TeamAssemblerProto_UserPatch.internalBinaryWrite(message.userPatches[i], writer.tag(7, WireType.LengthDelimited).fork(), options).join();
        /* bool advanced = 8; */
        if (message.advanced !== false)
            writer.tag(8, WireType.Varint).bool(message.advanced);
...
class TeamAssemblerProto_InputDeck$Type extends MessageType<TeamAssemblerProto_InputDeck> {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: TeamAssemblerProto_InputDeck): TeamAssemblerProto_InputDeck {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: TeamAssemblerProto_InputDeck, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* string id = 1; */
        if (message.id !== "")
...
class TeamAssemblerProto_PickedAssembly$Type extends MessageType<TeamAssemblerProto_PickedAssembly> {
    constructor() {
        super("TeamAssemblerProto.PickedAssembly", [
            { no: 1, name: "decks", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => TeamAssemblerProto_PickedAssembly_Deck }
        ]);
    }
    create(value?: PartialMessage<TeamAssemblerProto_PickedAssembly>): TeamAssemblerProto_PickedAssembly {
        const message = { decks: [] };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: TeamAssemblerProto_PickedAssembly): TeamAssemblerProto_PickedAssembly {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* repeated TeamAssemblerProto.PickedAssembly.Deck decks */ 1:
                    message.decks.push(TeamAssemblerProto_PickedAssembly_Deck.internalBinaryRead(reader, reader.uint32(), options));
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
    ...
    internalBinaryWrite(message: TeamAssemblerProto_PickedAssembly, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* repeated TeamAssemblerProto.PickedAssembly.Deck decks = 1; */
        for (let i = 0; i < message.decks.length; i++)
            TeamAssemblerProto_PickedAssembly_Deck.internalBinaryWrite(message.decks[i], writer.tag(1, WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
class TeamAssemblerProto_PickedAssembly_Deck$Type extends MessageType<TeamAssemblerProto_PickedAssembly_Deck> {
    ...
    create(value?: PartialMessage<TeamAssemblerProto_PickedAssembly_Deck>): TeamAssemblerProto_PickedAssembly_Deck {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: TeamAssemblerProto_PickedAssembly_Deck): TeamAssemblerProto_PickedAssembly_Deck {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: TeamAssemblerProto_PickedAssembly_Deck, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* string id = 1; */
        if (message.id !== "")
            writer.tag(1, WireType.LengthDelimited).string(message.id);
        /* string rename = 2; */
 ...
 */
export const TeamAssemblerProto_PickedAssembly_Deck = new TeamAssemblerProto_PickedAssembly_Deck$Type();
// @generated message type with reflection information, may provide speed optimized methods
class TeamAssemblerProto_UserPatch$Type extends MessageType<TeamAssemblerProto_UserPatch> {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: TeamAssemblerProto_UserPatch): TeamAssemblerProto_UserPatch {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: TeamAssemblerProto_UserPatch, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* int32 id = 1; */
        if (message.id !== 0)
