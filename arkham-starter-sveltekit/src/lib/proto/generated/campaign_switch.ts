...
class CampaignSwitchProto$Type extends MessageType<CampaignSwitchProto> {
    constructor() {
        super("CampaignSwitchProto", [
            { no: 1, name: "campaigns", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => CampaignSwitchProto_Campaign }
        ]);
    }
    create(value?: PartialMessage<CampaignSwitchProto>): CampaignSwitchProto {
        ...
        message.campaigns = [];
        if (value !== undefined)
            reflectionMergePartial<CampaignSwitchProto>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: CampaignSwitchProto): CampaignSwitchProto {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* repeated CampaignSwitchProto.Campaign campaigns */ 1:
                    message.campaigns.push(CampaignSwitchProto_Campaign.internalBinaryRead(reader, reader.uint32(), options));
                    break;
                default:
    ...
    internalBinaryWrite(message: CampaignSwitchProto, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* repeated CampaignSwitchProto.Campaign campaigns = 1; */
        for (let i = 0; i < message.campaigns.length; i++)
            CampaignSwitchProto_Campaign.internalBinaryWrite(message.campaigns[i], writer.tag(1, WireType.LengthDelimited).fork(), options).join();
...
class CampaignSwitchProto_Campaign$Type extends MessageType<CampaignSwitchProto_Campaign> {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: CampaignSwitchProto_Campaign): CampaignSwitchProto_Campaign {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                ...
                case /* CampaignSwitchProto.InputDeck deck_1 */ 2:
                    message.deck1 = CampaignSwitchProto_InputDeck.internalBinaryRead(reader, reader.uint32(), options, message.deck1);
                    break;
                case /* CampaignSwitchProto.InputDeck deck_2 */ 3:
                    message.deck2 = CampaignSwitchProto_InputDeck.internalBinaryRead(reader, reader.uint32(), options, message.deck2);
                    break;
                case /* CampaignSwitchProto.InputDeck deck_3 */ 4:
                    message.deck3 = CampaignSwitchProto_InputDeck.internalBinaryRead(reader, reader.uint32(), options, message.deck3);
                    break;
                case /* CampaignSwitchProto.InputDeck deck_4 */ 5:
                    message.deck4 = CampaignSwitchProto_InputDeck.internalBinaryRead(reader, reader.uint32(), options, message.deck4);
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
    ...
    internalBinaryWrite(message: CampaignSwitchProto_Campaign, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* string name = 1; */
        if (message.name !== "")
            writer.tag(1, WireType.LengthDelimited).string(message.name);
        /* CampaignSwitchProto.InputDeck deck_1 = 2; */
        if (message.deck1)
            CampaignSwitchProto_InputDeck.internalBinaryWrite(message.deck1, writer.tag(2, WireType.LengthDelimited).fork(), options).join();
        /* CampaignSwitchProto.InputDeck deck_2 = 3; */
        if (message.deck2)
            CampaignSwitchProto_InputDeck.internalBinaryWrite(message.deck2, writer.tag(3, WireType.LengthDelimited).fork(), options).join();
        /* CampaignSwitchProto.InputDeck deck_3 = 4; */
        if (message.deck3)
            CampaignSwitchProto_InputDeck.internalBinaryWrite(message.deck3, writer.tag(4, WireType.LengthDelimited).fork(), options).join();
        /* CampaignSwitchProto.InputDeck deck_4 = 5; */
        if (message.deck4)
            CampaignSwitchProto_InputDeck.internalBinaryWrite(message.deck4, writer.tag(5, WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
class CampaignSwitchProto_InputDeck$Type extends MessageType<CampaignSwitchProto_InputDeck> {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: CampaignSwitchProto_InputDeck): CampaignSwitchProto_InputDeck {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: CampaignSwitchProto_InputDeck, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* string id = 1; */
        if (message.id !== "")
