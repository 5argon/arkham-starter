...
class CardInfo$Type extends MessageType<CardInfo> {
	constructor() {
		super('CardInfo', [
			{
				no: 1,
				name: 'card_info_types',
				kind: 'enum',
				repeat: 1 /*RepeatType.PACKED*/,
				T: () => ['CardInfo.CardInfoType', CardInfo_CardInfoType],
			},
	...
	create(value?: PartialMessage<CardInfo>): CardInfo {
		const message = { cardInfoTypes: [] }
		globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this })
		if (value !== undefined) reflectionMergePartial<CardInfo>(this, message, value)
		return message
	}
	internalBinaryRead(
		...
		while (reader.pos < end) {
			...
			switch (fieldNo) {
				case /* repeated CardInfo.CardInfoType card_info_types */ 1:
					...
					else message.cardInfoTypes.push(reader.int32())
					break
				case /* CardInfo.TraitOptions trait_options */ 2:
					message.traitOptions = CardInfo_TraitOptions.internalBinaryRead(
						reader,
						reader.uint32(),
						options,
				...
				case /* CardInfo.CommitOptions commit_options */ 3:
					message.commitOptions = CardInfo_CommitOptions.internalBinaryRead(
						reader,
						reader.uint32(),
						options,
	...
	internalBinaryWrite(
		...
		if (message.cardInfoTypes.length) {
			...
			for (let i = 0; i < message.cardInfoTypes.length; i++) writer.int32(message.cardInfoTypes[i])
			writer.join()
		}
		/* CardInfo.TraitOptions trait_options = 2; */
		if (message.traitOptions)
			CardInfo_TraitOptions.internalBinaryWrite(
				message.traitOptions,
		...
		if (message.commitOptions)
			CardInfo_CommitOptions.internalBinaryWrite(
				message.commitOptions,
...
class CardInfo_TraitOptions$Type extends MessageType<CardInfo_TraitOptions> {
	...
	create(value?: PartialMessage<CardInfo_TraitOptions>): CardInfo_TraitOptions {
		...
		globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this })
		if (value !== undefined) reflectionMergePartial<CardInfo_TraitOptions>(this, message, value)
		return message
	}
	internalBinaryRead(
		reader: IBinaryReader,
		length: number,
		options: BinaryReadOptions,
		target?: CardInfo_TraitOptions,
	): CardInfo_TraitOptions {
		const message = target ?? this.create(),
			end = reader.pos + length
		while (reader.pos < end) {
			const [fieldNo, wireType] = reader.tag()
	...
	internalBinaryWrite(
		message: CardInfo_TraitOptions,
		writer: IBinaryWriter,
		options: BinaryWriteOptions,
	): IBinaryWriter {
		/* string highlight = 1; */
		if (message.highlight !== '') writer.tag(1, WireType.LengthDelimited).string(message.highlight)
		const u = options.writeUnknownFields
		if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer)
		return writer
	}
...
class CardInfo_CommitOptions$Type extends MessageType<CardInfo_CommitOptions> {
		...
		super('CardInfo.CommitOptions', [
			{
				...
				name: 'highlight',
				kind: 'enum',
				T: () => ['CardInfo.CommitOptions.CommitIcon', CardInfo_CommitOptions_CommitIcon],
			},
		])
	}
	create(value?: PartialMessage<CardInfo_CommitOptions>): CardInfo_CommitOptions {
		const message = { highlight: 0 }
		globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this })
		if (value !== undefined) reflectionMergePartial<CardInfo_CommitOptions>(this, message, value)
		return message
	}
	internalBinaryRead(
		reader: IBinaryReader,
		length: number,
		options: BinaryReadOptions,
		target?: CardInfo_CommitOptions,
	): CardInfo_CommitOptions {
		const message = target ?? this.create(),
			end = reader.pos + length
		while (reader.pos < end) {
			const [fieldNo, wireType] = reader.tag()
	...
	internalBinaryWrite(
		message: CardInfo_CommitOptions,
		writer: IBinaryWriter,
		options: BinaryWriteOptions,
	): IBinaryWriter {
		/* CardInfo.CommitOptions.CommitIcon highlight = 1; */
		if (message.highlight !== 0) writer.tag(1, WireType.Varint).int32(message.highlight)
		const u = options.writeUnknownFields
		if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer)
		return writer
	}
