...
export interface CardOptions {
    ...
    /**
     * @generated from protobuf field: bool expansion = 7;
     */
    expansion: boolean;
}
...
class CardOptions$Type extends MessageType<CardOptions> {
    constructor() {
        super("CardOptions", [
            ...
            { no: 7, name: "expansion", kind: "scalar", T: 8 /*ScalarType.BOOL*/ }
        ]);
    }
    create(value?: PartialMessage<CardOptions>): CardOptions {
        const message = globalThis.Object.create((this.messagePrototype!));
        message.classIcons = false;
        message.color = false;
        message.bold = false;
        message.link = false;
        message.tabooIcon = false;
        message.exceptionalIcon = false;
        message.expansion = false;
        if (value !== undefined)
            reflectionMergePartial<CardOptions>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: CardOptions): CardOptions {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* bool exceptional_icon */ 6:
                    ...
                    break;
                case /* bool expansion */ 7:
                    message.expansion = reader.bool();
                    break;
                default:
    ...
    internalBinaryWrite(message: CardOptions, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* bool class_icons = 1; */
        if (message.classIcons !== false)
            writer.tag(1, WireType.Varint).bool(message.classIcons);
        /* bool color = 2; */
        if (message.color !== false)
            writer.tag(2, WireType.Varint).bool(message.color);
        /* bool bold = 3; */
        if (message.bold !== false)
            writer.tag(3, WireType.Varint).bool(message.bold);
        /* bool link = 4; */
        if (message.link !== false)
            writer.tag(4, WireType.Varint).bool(message.link);
        /* bool taboo_icon = 5; */
        if (message.tabooIcon !== false)
            writer.tag(5, WireType.Varint).bool(message.tabooIcon);
        /* bool exceptional_icon = 6; */
        if (message.exceptionalIcon !== false)
            writer.tag(6, WireType.Varint).bool(message.exceptionalIcon);
        /* bool expansion = 7; */
        if (message.expansion !== false)
            writer.tag(7, WireType.Varint).bool(message.expansion);
